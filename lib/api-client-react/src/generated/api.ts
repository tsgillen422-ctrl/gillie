...
export const getGetFriendSuggestionsUrl = (params?: GetFriendSuggestionsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/friends/suggestions?${stringifiedParams}` : `/api/friends/suggestions`
}

/**
 * @summary Get recommended people to connect with
 */
export const getFriendSuggestions = async (params?: GetFriendSuggestionsParams, options?: RequestInit): Promise<SuggestedUser[]> => {

  return customFetch<SuggestedUser[]>(getGetFriendSuggestionsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetFriendSuggestionsQueryKey = (params?: GetFriendSuggestionsParams,) => {
    return [
    `/api/friends/suggestions`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetLakeDetailUrl = (lakeId: number,) => {




  return `/api/lakes/${lakeId}/detail`
}

/**
 * @summary Rich viewer-scoped preview of one lake community for the Lake Overview page
 */
export const getLakeDetail = async (lakeId: number, options?: RequestInit): Promise<LakeDetail> => {

  return customFetch<LakeDetail>(getGetLakeDetailUrl(lakeId),
  {
    ...options,
    method: 'GET'
...
export const getGetLakeDetailQueryKey = (lakeId: number,) => {
    return [
    `/api/lakes/${lakeId}/detail`
    ] as const;
    }


export const getGetLakeDetailQueryOptions = <TData = Awaited<ReturnType<typeof getLakeDetail>>, TError = ErrorType<void>>(lakeId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLakeDetail>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetLakeDetailQueryKey(lakeId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getLakeDetail>>> = ({ signal }) => getLakeDetail(lakeId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(lakeId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getLakeDetail>>, TError, TData> & { queryKey: QueryKey }
}

export type GetLakeDetailQueryResult = NonNullable<Awaited<ReturnType<typeof getLakeDetail>>>
export type GetLakeDetailQueryError = ErrorType<void>
...
export function useGetLakeDetail<TData = Awaited<ReturnType<typeof getLakeDetail>>, TError = ErrorType<void>>(
 lakeId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLakeDetail>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getGetBusinessTypesUrl = () => {




  return `/api/businesses/types`
}

/**
 * @summary Business type autocomplete suggestions
 */
export const getBusinessTypes = async ( options?: RequestInit): Promise<string[]> => {

  return customFetch<string[]>(getGetBusinessTypesUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetBusinessTypesQueryKey = () => {
    return [
...
export const getGetBusinessTypesQueryOptions = <TData = Awaited<ReturnType<typeof getBusinessTypes>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBusinessTypes>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetBusinessTypesQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getBusinessTypes>>> = ({ signal }) => getBusinessTypes({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBusinessTypes>>, TError, TData> & { queryKey: QueryKey }
}

export type GetBusinessTypesQueryResult = NonNullable<Awaited<ReturnType<typeof getBusinessTypes>>>
export type GetBusinessTypesQueryError = ErrorType<unknown>
...
export function useGetBusinessTypes<TData = Awaited<ReturnType<typeof getBusinessTypes>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBusinessTypes>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetBusinessTypesQueryOptions(options)
...
export const getGetMyBusinessQueryOptions = <TData = Awaited<ReturnType<typeof getMyBusiness>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMyBusiness>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetMyBusinessQueryError = ErrorType<ErrorEnvelope>
...
export function useGetMyBusiness<TData = Awaited<ReturnType<typeof getMyBusiness>>, TError = ErrorType<ErrorEnvelope>>(
 ...
 */
export const upsertMyBusiness = async (businessInput: BusinessInput, options?: RequestInit): Promise<Business> => {
...
export const getUpsertMyBusinessMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertMyBusiness>>, TError,{data: BodyType<BusinessInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof upsertMyBusiness>>, TError,{data: BodyType<BusinessInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof upsertMyBusiness>>, {data: BodyType<BusinessInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpsertMyBusinessMutationResult = NonNullable<Awaited<ReturnType<typeof upsertMyBusiness>>>
    export type UpsertMyBusinessMutationBody = BodyType<BusinessInput>
    export type UpsertMyBusinessMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Create or update the caller's business profile (resets status to pending)
 */
export const useUpsertMyBusiness = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertMyBusiness>>, TError,{data: BodyType<BusinessInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getDeleteMyBusinessUrl = () => {
...
/**
 * @summary Delete the caller's business profile
 */
export const deleteMyBusiness = async ( options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteMyBusinessUrl(),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteMyBusinessMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteMyBusiness>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteMyBusiness>>, TError,void, TContext> => {

const mutationKey = ['deleteMyBusiness'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteMyBusiness>>, void> = () => {


          return  deleteMyBusiness(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteMyBusinessMutationResult = NonNullable<Awaited<ReturnType<typeof deleteMyBusiness>>>

    export type DeleteMyBusinessMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Delete the caller's business profile
 */
export const useDeleteMyBusiness = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteMyBusiness>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteMyBusinessMutationOptions(options));
    }
...
export const getGetPendingBusinessesQueryOptions = <TData = Awaited<ReturnType<typeof getPendingBusinesses>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPendingBusinesses>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetPendingBusinessesQueryError = ErrorType<ErrorEnvelope>
...
export function useGetPendingBusinesses<TData = Awaited<ReturnType<typeof getPendingBusinesses>>, TError = ErrorType<ErrorEnvelope>>(
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetBusinessQueryKey(businessId);
   ...
   return  { queryKey, queryFn, enabled: !!(businessId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBusiness>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getUpdateBusinessMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateBusiness>>, TError,{businessId: number;data: BodyType<BusinessInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateBusiness>>, TError,{businessId: number;data: BodyType<BusinessInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateBusiness>>, {businessId: number;data: BodyType<BusinessInput>}> = (props) => {
...
export const useUpdateBusiness = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateBusiness>>, TError,{businessId: number;data: BodyType<BusinessInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {businessId: number;data: BodyType<BusinessInput>},
        TContext
      > => {
...
export const getFollowBusinessUrl = (businessId: number,) => {
  ...
  return `/api/businesses/${businessId}/follow`
}

/**
 * @summary Follow an approved business
 */
export const followBusiness = async (businessId: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getFollowBusinessUrl(businessId),
  {
    ...options,
    method: 'POST'
...
export const getFollowBusinessMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof followBusiness>>, TError,{businessId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof followBusiness>>, TError,{businessId: number}, TContext> => {

const mutationKey = ['followBusiness'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof followBusiness>>, {businessId: number}> = (props) => {
          const {businessId} = props ?? {};

          return  followBusiness(businessId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type FollowBusinessMutationResult = NonNullable<Awaited<ReturnType<typeof followBusiness>>>

    export type FollowBusinessMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Follow an approved business
 */
export const useFollowBusiness = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof followBusiness>>, TError,{businessId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof followBusiness>>,
        TError,
        {businessId: number},
        TContext
      > => {
      return useMutation(getFollowBusinessMutationOptions(options));
    }

export const getUnfollowBusinessUrl = (businessId: number,) => {
 ...
 */
export const unfollowBusiness = async (businessId: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getUnfollowBusinessUrl(businessId),
  {
    ...options,
    method: 'DELETE'
...
export const getUnfollowBusinessMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof unfollowBusiness>>, TError,{businessId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof unfollowBusiness>>, TError,{businessId: number}, TContext> => {

const mutationKey = ['unfollowBusiness'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof unfollowBusiness>>, {businessId: number}> = (props) => {
          const {businessId} = props ?? {};

          return  unfollowBusiness(businessId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UnfollowBusinessMutationResult = NonNullable<Awaited<ReturnType<typeof unfollowBusiness>>>

    export type UnfollowBusinessMutationError = ErrorType<unknown>

    /**
 * @summary Unfollow a business
 */
export const useUnfollowBusiness = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof unfollowBusiness>>, TError,{businessId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof unfollowBusiness>>,
        TError,
        {businessId: number},
        TContext
      > => {
      return useMutation(getUnfollowBusinessMutationOptions(options));
    }
 ...
 */
export const getBusinessReviews = async (businessId: number, options?: RequestInit): Promise<BusinessReview[]> => {

  return customFetch<BusinessReview[]>(getGetBusinessReviewsUrl(businessId),
  {
    ...options,
    method: 'GET'
...
export const getGetBusinessReviewsQueryOptions = <TData = Awaited<ReturnType<typeof getBusinessReviews>>, TError = ErrorType<ErrorEnvelope>>(businessId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBusinessReviews>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetBusinessReviewsQueryError = ErrorType<ErrorEnvelope>
...
export function useGetBusinessReviews<TData = Awaited<ReturnType<typeof getBusinessReviews>>, TError = ErrorType<ErrorEnvelope>>(
...
export const getUpsertBusinessReviewUrl = (businessId: number,) => {
 ...
 */
export const upsertBusinessReview = async (businessId: number,
    businessReviewInput: BusinessReviewInput, options?: RequestInit): Promise<BusinessReview> => {

  return customFetch<BusinessReview>(getUpsertBusinessReviewUrl(businessId),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpsertBusinessReviewMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertBusinessReview>>, TError,{businessId: number;data: BodyType<BusinessReviewInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof upsertBusinessReview>>, TError,{businessId: number;data: BodyType<BusinessReviewInput>}, TContext> => {

const mutationKey = ['upsertBusinessReview'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof upsertBusinessReview>>, {businessId: number;data: BodyType<BusinessReviewInput>}> = (props) => {
          const {businessId,data} = props ?? {};

          return  upsertBusinessReview(businessId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpsertBusinessReviewMutationResult = NonNullable<Awaited<ReturnType<typeof upsertBusinessReview>>>
    export type UpsertBusinessReviewMutationBody = BodyType<BusinessReviewInput>
    export type UpsertBusinessReviewMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Create or update the caller's review (one per business)
 */
export const useUpsertBusinessReview = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertBusinessReview>>, TError,{businessId: number;data: BodyType<BusinessReviewInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof upsertBusinessReview>>,
        TError,
        {businessId: number;data: BodyType<BusinessReviewInput>},
        TContext
      > => {
      return useMutation(getUpsertBusinessReviewMutationOptions(options));
    }

export const getDeleteBusinessReviewUrl = (businessId: number,) => {
 ...
 */
export const deleteBusinessReview = async (businessId: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteBusinessReviewUrl(businessId),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteBusinessReviewMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteBusinessReview>>, TError,{businessId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteBusinessReview>>, TError,{businessId: number}, TContext> => {

const mutationKey = ['deleteBusinessReview'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteBusinessReview>>, {businessId: number}> = (props) => {
          const {businessId} = props ?? {};

          return  deleteBusinessReview(businessId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteBusinessReviewMutationResult = NonNullable<Awaited<ReturnType<typeof deleteBusinessReview>>>

    export type DeleteBusinessReviewMutationError = ErrorType<unknown>

    /**
 * @summary Delete the caller's review of a business
 */
export const useDeleteBusinessReview = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteBusinessReview>>, TError,{businessId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteBusinessReview>>,
        TError,
        {businessId: number},
        TContext
      > => {
      return useMutation(getDeleteBusinessReviewMutationOptions(options));
    }

export const getGetBusinessPostsUrl = (businessId: number,) => {




  return `/api/businesses/${businessId}/posts`
}

/**
 * @summary List a business's posts and events
 */
export const getBusinessPosts = async (businessId: number, options?: RequestInit): Promise<Post[]> => {

  return customFetch<Post[]>(getGetBusinessPostsUrl(businessId),
  {
    ...options,
    method: 'GET'
...
export const getGetBusinessPostsQueryKey = (businessId: number,) => {
    return [
...
export const getGetBusinessPostsQueryOptions = <TData = Awaited<ReturnType<typeof getBusinessPosts>>, TError = ErrorType<ErrorEnvelope>>(businessId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBusinessPosts>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetBusinessPostsQueryKey(businessId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getBusinessPosts>>> = ({ signal }) => getBusinessPosts(businessId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(businessId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBusinessPosts>>, TError, TData> & { queryKey: QueryKey }
}

export type GetBusinessPostsQueryResult = NonNullable<Awaited<ReturnType<typeof getBusinessPosts>>>
export type GetBusinessPostsQueryError = ErrorType<ErrorEnvelope>
...
export function useGetBusinessPosts<TData = Awaited<ReturnType<typeof getBusinessPosts>>, TError = ErrorType<ErrorEnvelope>>(
 businessId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBusinessPosts>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetBusinessPostsQueryOptions(businessId,options)
...
export const getCreateBusinessPostUrl = () => {




  return `/api/businesses/me/posts`
}

/**
 * @summary Publish an update or event as your approved business
 */
export const createBusinessPost = async (businessPostInput: BusinessPostInput, options?: RequestInit): Promise<Post> => {

  return customFetch<Post>(getCreateBusinessPostUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateBusinessPostMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createBusinessPost>>, TError,{data: BodyType<BusinessPostInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createBusinessPost>>, TError,{data: BodyType<BusinessPostInput>}, TContext> => {

const mutationKey = ['createBusinessPost'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createBusinessPost>>, {data: BodyType<BusinessPostInput>}> = (props) => {
          const {data} = props ?? {};

          return  createBusinessPost(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateBusinessPostMutationResult = NonNullable<Awaited<ReturnType<typeof createBusinessPost>>>
    export type CreateBusinessPostMutationBody = BodyType<BusinessPostInput>
    export type CreateBusinessPostMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Publish an update or event as your approved business
 */
export const useCreateBusinessPost = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createBusinessPost>>, TError,{data: BodyType<BusinessPostInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createBusinessPost>>,
        TError,
        {data: BodyType<BusinessPostInput>},
        TContext
      > => {
      return useMutation(getCreateBusinessPostMutationOptions(options));
    }

export const getSetBusinessStatusUrl = (businessId: number,) => {




  return `/api/businesses/${businessId}/status`
}

/**
 * @summary Admin - approve or reject a business profile
 */
export const setBusinessStatus = async (businessId: number,
    businessStatusInput: BusinessStatusInput, options?: RequestInit): Promise<Business> => {

  return customFetch<Business>(getSetBusinessStatusUrl(businessId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getSetBusinessStatusMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setBusinessStatus>>, TError,{businessId: number;data: BodyType<BusinessStatusInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof setBusinessStatus>>, TError,{businessId: number;data: BodyType<BusinessStatusInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setBusinessStatus>>, {businessId: number;data: BodyType<BusinessStatusInput>}> = (props) => {
          const {businessId,data} = props ?? {};

          return  setBusinessStatus(businessId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SetBusinessStatusMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Admin - approve or reject a business profile
 */
export const useSetBusinessStatus = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setBusinessStatus>>, TError,{businessId: number;data: BodyType<BusinessStatusInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof setBusinessStatus>>,
        TError,
        {businessId: number;data: BodyType<BusinessStatusInput>},
        TContext
      > => {
