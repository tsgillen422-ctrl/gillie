...
export const GetPinsQueryParams = zod.object({
  "type": zod.enum(['fishing_spot', 'cliff', 'waterfall', 'rope_swing', 'shallow_water', 'landmark', 'hazard', 'marina', 'campsite', 'other']).optional(),
...
export const GetPinsResponseItem = zod.object({
  ...
  "lat": zod.number(),
  "lng": zod.number(),
  "type": zod.enum(['fishing_spot', 'cliff', 'waterfall', 'rope_swing', 'shallow_water', 'landmark', 'hazard', 'marina', 'campsite', 'other']),
  "title": zod.string(),
