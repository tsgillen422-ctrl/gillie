...
export const GetConditionsQueryParams = zod.object({
  "lakeId": zod.coerce.number().optional().describe('Which lake to fetch conditions for (defaults to the default lake community)')
})
...
export const GetConditionsResponse = zod.object({
  ...
  "waterLevel": zod.number().nullish().describe('Lake pool elevation in feet (USACE gauge for the lake).'),
...
export const CreatePinBody = zod.object({
  ...
  "expiresAt": zod.string().nullish(),
  "lakeId": zod.number().nullish().describe('Which lake the pin belongs to (defaults to the default lake community)')
})
...
export const CreateDockLabelBody = zod.object({
  ...
  "lat": zod.number(),
  "lng": zod.number(),
  "lakeId": zod.number().nullish().describe('Which lake the dock label belongs to (defaults to the default lake community)')
})
...
export const CreateCatchBody = zod.object({
  ...
  "lakeId": zod.number().nullish().describe('Which lake the catch belongs to (defaults to the default lake community)')
})
