...
- [Location sharing model](location-checkin-model.md) — Snapchat-style opt-in w/ sliding 24h auto-ghost; serializers emit NULL coords unless route passes includeLiveLocation after an audience check.
